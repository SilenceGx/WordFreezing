...
## 2026-08-02 — 新增：雅思核心词库（3592 词，可直接导入）

### 内容
- [x] `wordlists/ielts-core-3592.txt` — 纯单词列表（每行一词，小写）
- [x] `wordlists/ielts-core-3592-examples.txt` — `单词|例句` 格式（3592 条 AI 生成地道例句），翻译模式开箱即用
- [x] `wordlists/ielts-core-3592-full.json` — 全字段（词性/音标/释义/例句），与应用内「导出词本 → JSON」格式一致
- [x] `wordlists/README.md` — 格式对比/快速开始/来源版权/FAQ

### 来源与处理
- 单词提取自 [fanhongtao/IELTS](https://github.com/fanhongtao/IELTS)（新东方《雅思词汇词根+联想记忆法》逐词录入）
- 清洗：取行首词目 → 去 `*` 难度标记 → 保留连字符复合词 → 丢弃多词短语 → 去重（3611 → 3592）
- 词性/音标/释义/例句由 DeepSeek AI 批量补全（3612 词全部完成）
- 版权：原仓库未声明许可证，仅提取单词词目；释义等为 AI 生成非原书内容
